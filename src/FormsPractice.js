...
class FormsPractice extends Component {
    ...
    render() {
        return (
            <main>
                <form>
                    <input name="firstName" value={this.state.firtName} onChange={this.handleChange} placeholder="First Name"/> <br />
                    ...
                    <label>
                        <input name="gender" value="male" checked={this.state.gender === "male"} onChange={this.handleChange} type="radio" /> Male
                        <input name="gender" value="female" checked={this.state.gender === "female"} onChange={this.handleChange} type="radio" /> Female
                    </label>
                    <br/>
